...
export default function WeekStrip({ trainedDates = [], streak = 0, className = "" }) {
  ...
  return (
    <section
      ...
      className={`rounded-[10px] border border-[#5A1215] bg-surface p-4 shadow-sm ${className}`}
    >
      <div className="flex items-center justify-between gap-2 pb-3">
        ...
        <p
          aria-live="polite"
          className="min-w-0 truncate text-center text-[11px] font-bold uppercase tracking-[0.12em] text-[#3B0A0C]"
        >
      ...
      <div className="grid grid-cols-7 gap-1">
        {days.map((day, i) => (
          <div
            ...
            className={`flex min-h-[52px] flex-col items-center justify-center gap-1 rounded-[8px] border py-2 transition sm:min-h-[58px] ${
              day.isToday
          ...
          >
            ...
            <span
              className={`font-sans text-[15px] font-bold leading-none ${
      ...
      {streak > 0 && (
        <p className="pt-2.5 text-center text-[10px] font-semibold text-[#645C55]">
