  ...
  return (
    <>
      ...
      <div className="flex flex-col px-[18px]">
        ...
        <div className="mb-3 grid grid-cols-2 gap-2.5">
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <span className="text-[13px] font-semibold tracking-[-0.01em]">Volumen</span>
              <svg
                viewBox="0 0 24 24"
                width="17"
                height="17"
          ...
          >
            <div>
              <p className="text-[13px] font-semibold tracking-[-0.01em]">Tu objetivo</p>
            ...
            <div className="flex items-center justify-end gap-2">
              <span
                ...
                style={{
                  background: "conic-gradient(#fff 0 0%, rgba(255,255,255,.26) 0)",
                }}
              >
                <span
        ...
        >
          <p className="text-[13px] font-semibold tracking-[-0.01em]">¿Entrenás con alguien?</p>
          <p className="mt-1 text-[11px] text-faint">Ingresá su código de invitación.</p>
