...
function serializeUser(doc) {
  ...
  return {
    ...
    weeklyCalorieGoalKcal: data.weeklyCalorieGoalKcal || null,
...
export async function updateUserProfile(uid, data) {
  ...
  if (data.weeklyCalorieGoalKcal !== undefined) {
    const value =
      data.weeklyCalorieGoalKcal === null || data.weeklyCalorieGoalKcal === ""
        ? null
        : Number(data.weeklyCalorieGoalKcal);
    if (value !== null && (!Number.isFinite(value) || value <= 0 || value > 50000)) {
      throw new Error("Objetivo de calorías inválido.");
    }
    update.weeklyCalorieGoalKcal = value;
  }
